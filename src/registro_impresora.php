...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = mysqli_query($conexion, "SELECT * FROM registro_impresora WHERE placa = '$placa'");
    if (mysqli_num_rows($query) > 0) {
        ...
        if (mysqli_num_rows($proveedor_exists) == 0 || mysqli_num_rows($estado_exists) == 0 || mysqli_num_rows($cliente_exists) == 0 || mysqli_num_rows($tecnico_exists) == 0) {
            ...
            $query_insert = mysqli_query($conexion, "INSERT INTO registro_impresora (placa, serial, proveedor_id, marca, modelo, nota, estado_id, cliente_id, tecnico_id, fecha_ingreso, fecha_salida, imagen) 
    ...
    <div class="modal-dialog" role="document" style="max-width: 1000px;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Agregar Registro Impresora</h5>
